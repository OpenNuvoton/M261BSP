...
void MainTask(void)
{
    extern GUI_CONST_STORAGE GUI_BITMAP bmM261_320x240;
    WM_HWIN hWin;
    char     *acVersion = "Nuvoton M261";
    int32_t i32Scale;
    ...
    i32Scale = 1000;
#endif
    GUI_DrawBitmapEx(&bmM261_320x240, 0, 5,0,0, i32Scale, i32Scale);                
    GUI_Delay(3000);
...
int main(void)
{
    ...
    printf("+-------------------------------------------------------------+\n");
    printf(" This demo code need to executed on NuMaker board with Nu_TFT v1.1/1.3 daughter board.\n");
    printf("\n\n");
