...
/*---------------------------------------------------------------------------------------------------------*/
#define NUBL2_FW_BASE           0x00000000ul    /* 0K, NuBL2 Firmware */
#define NUBL32_FW_BASE          0x00040000ul    /* 256K, NuBL32 Firmware; SRAM 32~48K */
    
#define NUBL2_LIB_BASE          0x0002C000ul    /* 176K (0x2C000) */
#define NUBL32_LIB_BASE         0x00047000ul    /* 284K (0x47000) */

#define NUBL1_IB_BASE           (0x00060000ul - (1024*2)) /* 382K, 0x5F800 */

#define KEY_STORAGE_BASE        (NUBL1_IB_BASE - (1024*2))  /* 380K, 0x5F000 (encrypt [NuBL32 and Host(for cmd) public keys]) */
