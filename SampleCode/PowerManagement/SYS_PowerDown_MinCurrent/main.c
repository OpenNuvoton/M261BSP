...
int32_t main(void)
{
    ...
    /*
        ...
        On NuMaker-M263KI V1.3 board, remove components, e.g. Nu-Link2-Me and R7.
    ...
    */
    ...
    /*
        ...
        On NuMaker-M263KI V1.3 board, configure GPIO as input mode pull-down if they have pull-down resister outside:
        PA.12(USB_VBUS),
        PB.15(USB_VBUS_EN).
    */
