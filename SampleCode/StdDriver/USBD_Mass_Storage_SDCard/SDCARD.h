 ...
 * @file     sdcard.h
 * @version  V1.00
 * @brief    M261 series SD Card driver header file
 *
 * @note
...
/** @addtogroup M261_Library M261 Library
  @{
*/

/** @addtogroup M261_SDCARD SDCARD Library
  @{
*/

/** @addtogroup M261_SDCARD_EXPORTED_CONSTANTS SDCARD Library Exported Constants
  @{
*/
...
/*@}*/ /* end of group M261_SDCARD_EXPORTED_CONSTANTS */

/** @addtogroup M261_SDCARD_EXPORTED_STRUCTS SDCARD Library Exported Structs
  @{
*/
...
/*@}*/ /* end of group M261_SDCARD_EXPORTED_STRUCTS */

/** @addtogroup M261_SDCARD_EXPORTED_FUNCTIONS SDCARD Library Exported Functions
  @{
*/
...
/*@}*/ /* end of group M261_SDCARD */

/*@}*/ /* end of group M261_Library */
